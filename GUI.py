...
def update_results():
    counter1 = PerformanceDetection_GUI.counter1  # Get counter values directly
    counter2 = PerformanceDetection_GUI.counter2

    # Update Entry widgets 
    staff1_entry.configure(state="normal")
    staff1_entry.delete(0, "end")
    staff1_entry.insert(0, counter1)
    staff1_entry.configure(state="readonly")

    staff2_entry.configure(state="normal")
    staff2_entry.delete(0, "end")
    staff2_entry.insert(0, counter2)
    staff2_entry.configure(state="readonly")

    # Schedule the next update after 5 seconds
    app.after(5000, update_results) 
...
staff1_entry = ttk.Entry(labelframe_analysis, state="readonly")  # Create the entry first
...
staff2_entry = ttk.Entry(labelframe_analysis, state="readonly")  # Create the entry first
